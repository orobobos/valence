"""Trust graph service for managing trust relationships.

Provides high-level API for granting, revoking, and querying trust relationships.
"""
...
from .propagation import compute_delegated_trust
