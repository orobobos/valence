...
def cmd_qos_status(args: argparse.Namespace) -> int:
    ...
    from our_network.qos import QoSPolicy
    from our_network.qos_manager import QoSManager
...
def cmd_qos_score(args: argparse.Namespace) -> int:
    ...
    from our_network.qos import ContributionDimension, ContributionScore, QoSPolicy
