...
def cmd_trust_set(args: argparse.Namespace) -> int:
    ...
    """
    from our_privacy.trust import EPISTEMIC_DIMENSIONS, TrustService
...
def cmd_trust_check(args: argparse.Namespace) -> int:
    ...
    from our_federation.trust import check_trust_concentration
    from our_federation.trust_policy import CONCENTRATION_THRESHOLDS
