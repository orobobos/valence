...
class TestSerialization:
    ...
    def test_to_dict_with_expiry(self):
        ...
        expiry = datetime(2027, 1, 1, 12, 0, 0, tzinfo=timezone.utc)
        edge = TrustEdge(
            source_did="did:key:alice",
            target_did="did:key:bob",
            competence=0.5,
    ...
    def test_from_dict(self):
        ...
        assert edge.expires_at == datetime(2027, 1, 1, tzinfo=timezone.utc)
    ...
    def test_roundtrip(self):
        ...
        original = TrustEdge(
            ...
            judgment=0.6,
            domain="research",
            expires_at=datetime(2027, 6, 15, tzinfo=timezone.utc),
        )
