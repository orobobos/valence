...
class TestDataReport:
    ...
    def sample_report(self):
        ...
        # Add beliefs
        report.beliefs.append(BeliefRecord(
            belief_id="belief-1",
        ...
        # Add shares
        report.shares_sent.append(ShareRecord(
            share_id="share-1",
            belief_id="belief-1",
            sharer_did="did:key:alice",
            recipient_did="did:key:bob",
        ...
        report.shares_received.append(ShareRecord(
            share_id="share-2",
            belief_id="belief-3",
        ...
        # Add trust edges
        report.trust_outgoing.append(TrustRecord(
            source_did="did:key:alice",
            target_did="did:key:bob",
            competence=0.8,
            integrity=0.9,
        ...
        report.trust_incoming.append(TrustRecord(
        ...
        # Add audit events
        report.audit_events.append(AuditRecord(
            event_id="event-1",
            event_type="share",
            actor_did="did:key:alice",
            target_did="did:key:bob",
...
class TestInMemoryDataSource:
    ...
    def data_source(self):
        ...
        # Add beliefs
        ds.beliefs.append(BeliefRecord(
            belief_id="b1",
            content="Belief 1",
            confidence=0.9,
            domains=["health"],
        ...
        # Add trust edges
        ds.trust_edges.append(TrustRecord(
            source_did="did:key:alice",
            target_did="did:key:bob",
            competence=0.8,
            integrity=0.9,
        ...
        # Add audit events
        ds.audit_events.append(AuditRecord(
            event_id="e1",
            event_type="share",
            actor_did="did:key:alice",
            target_did="did:key:bob",
...
class TestReportService:
    ...
    def service_with_data(self):
        ...
        # Add test data
        data_source.beliefs.append(BeliefRecord(
            belief_id="b1",
            content="Test belief",
            confidence=0.9,
            domains=["test"],
        ...
        data_source.shares.append(ShareRecord(
            share_id="s1",
            belief_id="b1",
            sharer_did="did:key:alice",
            recipient_did="did:key:bob",
        ...
        data_source.trust_edges.append(TrustRecord(
            source_did="did:key:alice",
            target_did="did:key:bob",
            competence=0.8,
            integrity=0.9,
        ...
        data_source.audit_events.append(AuditRecord(
            event_id="e1",
            event_type="share",
            actor_did="did:key:alice",
            target_did="did:key:bob",
