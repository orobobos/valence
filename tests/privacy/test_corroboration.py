...
from valence.privacy.elevation import ProposalStatus
...
class TestCorroboratingSource:
    ...
    def test_from_dict(self):
        ...
        assert source.corroborated_at == datetime(2026, 2, 4, 10, 30, 0, tzinfo=timezone.utc)
...
class TestCorroborationDetector:
    ...
    def test_find_similar_beliefs(self, detector, mock_embedding_func):
        ...
        beliefs = [
            {"id": "b1", "owner_did": "did:alice", "content": "AI tech machine learning", "share_level": "private"},
            {"id": "b2", "owner_did": "did:bob", "content": "AI tech", "share_level": "direct"},
            {"id": "b3", "owner_did": "did:carol", "content": "short", "share_level": "public"},
            {"id": "b4", "owner_did": "did:source", "content": "AI tech machine learning", "share_level": "private"},  # Same source
        ]
    ...
    def test_process_incoming_belief(self, detector, mock_embedding_func):
        ...
        local_beliefs = [
            {"id": "local-1", "owner_did": "did:local", "content": "AI tech machine learning research", "share_level": "private"},
        ]
    ...
    def test_process_incoming_belief_auto_proposes(self, detector, mock_embedding_func):
        ...
        local_beliefs = [
            {"id": "local-1", "owner_did": "did:local", "content": "AI tech machine learning", "share_level": "private"},
        ]
...
class TestEdgeCases:
    ...
    def test_similarity_just_below_threshold(self, detector):
        ...
        with pytest.raises(ValueError, match="below threshold"):
            detector.add_corroboration(
                "belief-1", "did:owner", "did:a", "a1", 0.849
            )
