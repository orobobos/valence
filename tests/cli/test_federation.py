...
class TestListCommand:
    ...
    async def test_list_success(self, mock_node_list, capsys):
        ...
        with patch("our_federation.tools.federation_node_list") as mock_list:
...
class TestTrustCommand:
    ...
    async def test_trust_set_elevated(self, capsys):
        ...
        with (
            patch("our_federation.tools.federation_trust_get") as mock_get,
            patch("our_federation.tools.federation_trust_set_preference") as mock_set,
        ):
    ...
    async def test_trust_node_not_found(self, capsys):
        ...
        with patch("our_federation.tools.federation_trust_get") as mock_get:
...
class TestSyncCommand:
    ...
    async def test_sync_all_nodes(self, capsys):
        ...
        with patch("our_federation.tools.federation_sync_trigger") as mock_trigger:
