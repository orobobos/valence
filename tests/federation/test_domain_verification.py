...
from valence.federation.verification import VerificationStatus
...
def reset_global_stores():
    ...
    import valence.federation.domain_verification as dv
...
class TestAttestationStore:
    ...
    def test_add_and_get(self, attestation_store: AttestationStore, test_domain: str, remote_fed_did: str, local_fed_did: str):
    ...
    def test_get_for_domain(self, attestation_store: AttestationStore, test_domain: str, remote_fed_did: str, local_fed_did: str):
    ...
    def test_get_for_domain_with_subject_filter(self, attestation_store: AttestationStore, test_domain: str, remote_fed_did: str, local_fed_did: str):
    ...
    def test_revoke(self, attestation_store: AttestationStore, test_domain: str, remote_fed_did: str, local_fed_did: str):
    ...
    def test_get_for_subject(self, attestation_store: AttestationStore, test_domain: str, remote_fed_did: str, local_fed_did: str):
...
class TestExternalAuthority:
    ...
    async def test_external_client_success(self, test_domain: str, remote_fed_did: str):
        ...
        mock_client.verify_domain = AsyncMock(return_value=(
            True,
            {"verified": True, "authority": "test"},
            None
        ))
