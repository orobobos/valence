...
class BenchmarkMetrics:
    ...
    def compute(
        ...
        relevance_grades: dict[UUID, int],
...
class TestAhaMoments:
    ...
    def test_scenario_valence_beats_baseline(self, scenario_name: str):
        ...
        print(
            f"Valence  - P@5: {valence_metrics.precision_at_5:.2f}, "
    ...
    def test_full_benchmark(self):
        ...
        for name, scenario_fn in self.SCENARIOS.items():
            ...
            print(f"\n{name}:")
            print(
                f"  Baseline MRR: {baseline_metrics.mrr:.3f}, Valence MRR: {valence_metrics.mrr:.3f} "
