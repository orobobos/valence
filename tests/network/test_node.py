...
class TestCreateNodeClient:
    ...
    def test_create_node_client_with_discovery(self, ed25519_keypair, x25519_keypair):
...
class TestMultiRouterConnections:
    ...
    def test_multiple_connections_tracked(self, node_client, mock_session):
    ...
    def test_health_tracking_per_router(self, node_client, mock_session):
    ...
    def test_best_router_selected_for_messages(self, node_client, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_failover_to_secondary_router(self, node_client, mock_session):
    ...
    def test_connection_status_reporting(self, node_client, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_ensure_connections_targets_config(self, node_client):
    ...
    def test_integration_with_failover_states(self, node_client):
