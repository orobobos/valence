...
class TestEndToEnd:
    ...
    def test_multiple_proof_types(self):
        ...
        proofs["revocation"] = prover3.prove(
            ...
            public_inputs={"credential_commitment": "commit", "revocation_accumulator": "acc"},
        )
        ...
        assert v3.verify(proofs["revocation"], {"credential_commitment": "commit", "revocation_accumulator": "acc"}).valid
