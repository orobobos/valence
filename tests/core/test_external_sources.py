...
class TestTrustedDomain:
    ...
    def test_create_basic_domain(self):
        ...
        domain = TrustedDomain(domain="example.com", category=SourceCategory.NEWS_MAJOR)
...
class TestDOIPrefix:
    ...
    def test_create_prefix(self):
        prefix = DOIPrefix(prefix="10.1038", publisher="Nature Publishing Group")
...
class TestLivenessCheckResult:
    ...
    def test_live_source(self):
        result = LivenessCheckResult(status=SourceLivenessStatus.LIVE, http_status=200)
        assert result.is_live

    def test_dead_source(self):
        result = LivenessCheckResult(status=SourceLivenessStatus.DEAD, http_status=404)
...
class TestExternalSourceVerificationService:
    ...
    def test_verify_doi(self, service, belief_id):
        ...
        v = service.create_verification(belief_id=belief_id, doi="10.1038/nature12345")
    ...
    def test_get_verification(self, service, belief_id):
        ...
        v = service.create_verification(belief_id=belief_id, url="https://example.com")
...
class TestEdgeCases:
    ...
    def test_invalid_url(self, service):
        ...
        v = service.create_verification(belief_id=uuid4(), url="not-a-valid-url")
    ...
    def test_empty_belief_content(self, service):
        ...
        v = service.create_verification(belief_id=uuid4(), url="https://example.com")
...
class TestConsensusIntegration:
    ...
    def test_l4_elevation_fails_with_only_failed_sources(self, service):
        ...
        service.create_verification(belief_id=belief_id, url="https://fake-science.com/article")
