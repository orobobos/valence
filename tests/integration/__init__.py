...
Environment Variables:
    VKB_DB_HOST: Database host (default: localhost)
    VKB_DB_PORT: Database port (default: 5433 for docker, 5432 for CI)
    VKB_DB_NAME: Database name (default: valence_test)
    VKB_DB_USER: Database user (default: valence)
    VKB_DB_PASSWORD: Database password (default: testpass)
